...
class Slug 
{
  ...
  color banjo_color = color(255, 0, 0, 150);
  color flute_color = color(0, 255, 0, 150);
  color violin_color = color(0, 0, 255, 150);
  ...
  void updateMode(int mode_num) {
    mode = mode_num;
  }

  //updateInfo(pitch, amplitude, frame_num, m_1, m_2, m_3);
  void updateInfo(float pitch, float amplitude, int frame_num, float m_1, float m_2, float m_3) {
    ...
    cur_radius = (int) map(amplitude, 0.0, 1.0, 0.0, max_height);
