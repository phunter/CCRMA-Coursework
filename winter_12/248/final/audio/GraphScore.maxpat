...
,
		"rect" : [ 420.0, 57.0, 1505.0, 1062.0 ],
		"bglocked" : 0,
		"defrect" : [ 420.0, 57.0, 1505.0, 1062.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "/midi 27 0",
					"numoutlets" : 1,
					"presentation_rect" : [ 1286.0, 286.0, 0.0, 0.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1281.0, 262.0, 63.0, 18.0 ],
					"id" : "obj-123",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "/midi 27 1",
					"numoutlets" : 1,
					"presentation_rect" : [ 1283.0, 263.0, 0.0, 0.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 234.0, 63.0, 18.0 ],
					"id" : "obj-121",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "/midi 22 0",
					"numoutlets" : 1,
					"presentation_rect" : [ 1277.0, 233.0, 0.0, 0.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 204.0, 63.0, 18.0 ],
					"id" : "obj-102",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "/midi 22 1",
					"numoutlets" : 1,
					"presentation_rect" : [ 1277.0, 206.0, 0.0, 0.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1280.0, 176.0, 63.0, 18.0 ],
					"id" : "obj-90",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 214.0, 745.0, 21.0, 21.0 ],
					"id" : "obj-79",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 747.0, 34.0, 18.0 ],
					"id" : "obj-85",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 126.0, 796.0, 61.0, 20.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
,
						"rect" : [ 3.0, 146.0, 798.0, 773.0 ],
						"bglocked" : 0,
						"defrect" : [ 3.0, 146.0, 798.0, 773.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
