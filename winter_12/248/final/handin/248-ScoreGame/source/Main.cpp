...
// fullscreen or no? Fullscreen Geometry is not yet working! :( :( :(
sf::Window window(sf::VideoMode(WIN_WIDTH, WIN_HEIGHT), "Final Project", sf::Style::Close, settings);
//sf::Window window(sf::VideoMode(1920, 1200, 32), "Final Project", sf::Style::Fullscreen, settings);
...
void initOpenGL() {
	...
	window_width = WIN_WIDTH; // = window.GetWidth();
	window_height = WIN_HEIGHT; // window.GetHeight();
